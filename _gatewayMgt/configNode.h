...
//
wpas wpa[] = {
  {"NorEXT","framon.a_1996"},
  {"wifi_Libre","revolucion2021"},
  {"Norma Net Piso 3","framon.a_1996"},
...
#define _DESCRIPTION "ESP5 Gateway"			// Name of the gateway
#define _EMAIL "mw12@hotmail.com"		// Owner
